...
There are several types of resuable code which each have their own responsibilities.

- [Components](components.md)
- [Composables](reusable-code/composables.md)
- [Services](reusable-code/services.md)
- [Stores](reusable-code/stores.md)
- [Mutations](reusable-code/mutations.md)
